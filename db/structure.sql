...
--
-- Name: COLUMN clinic_appointments.source_clinic_name; Type: COMMENT; Schema: renalware; Owner: -
--

COMMENT ON COLUMN renalware.clinic_appointments.source_clinic_name IS 'The name of the clinic in the source system';
...
--
-- Name: clinic_mappings; Type: TABLE; Schema: renalware; Owner: -
--

CREATE TABLE renalware.clinic_mappings (
    id bigint NOT NULL,
    name_in_feed character varying NOT NULL,
    clinic_id bigint,
    default_clinic boolean DEFAULT false NOT NULL,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL
);
...
--
-- Name: clinic_mappings_id_seq; Type: SEQUENCE; Schema: renalware; Owner: -
--

CREATE SEQUENCE renalware.clinic_mappings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: clinic_mappings_id_seq; Type: SEQUENCE OWNED BY; Schema: renalware; Owner: -
--

ALTER SEQUENCE renalware.clinic_mappings_id_seq OWNED BY renalware.clinic_mappings.id;
...
--
-- Name: COLUMN patient_practice_memberships.default_gp; Type: COMMENT; Schema: renalware; Owner: -
--

COMMENT ON COLUMN renalware.patient_practice_memberships.default_gp IS 'A membership with default_gp=true will be the default GP for a Practice in case the patient has no specific PrimaryCarePhysician assigned (one is required for letters etc). Only one (undeleted) membership per Practice can have default_gp=true. Generally this will be assigned to the system-level Generic PrimaryCarePhysician unless a specific PrimaryCarePhysician is assigned as default.';
...
--
-- Name: clinic_mappings id; Type: DEFAULT; Schema: renalware; Owner: -
--

ALTER TABLE ONLY renalware.clinic_mappings ALTER COLUMN id SET DEFAULT nextval('renalware.clinic_mappings_id_seq'::regclass);
...
--
-- Name: clinic_mappings clinic_mappings_pkey; Type: CONSTRAINT; Schema: renalware; Owner: -
--

ALTER TABLE ONLY renalware.clinic_mappings
    ADD CONSTRAINT clinic_mappings_pkey PRIMARY KEY (id);
...
--
-- Name: index_clinic_mappings_lower_name_in_feed; Type: INDEX; Schema: renalware; Owner: -
--

CREATE UNIQUE INDEX index_clinic_mappings_lower_name_in_feed ON renalware.clinic_mappings USING btree (lower((name_in_feed)::text));


--
-- Name: INDEX index_clinic_mappings_lower_name_in_feed; Type: COMMENT; Schema: renalware; Owner: -
--

COMMENT ON INDEX renalware.index_clinic_mappings_lower_name_in_feed IS 'Case insensitive index on HL7 clinic name';


--
-- Name: index_clinic_mappings_on_clinic_id; Type: INDEX; Schema: renalware; Owner: -
--

CREATE INDEX index_clinic_mappings_on_clinic_id ON renalware.clinic_mappings USING btree (clinic_id);


--
-- Name: index_clinic_mappings_on_default_true; Type: INDEX; Schema: renalware; Owner: -
--

CREATE UNIQUE INDEX index_clinic_mappings_on_default_true ON renalware.clinic_mappings USING btree (default_clinic) WHERE (default_clinic = true);


--
-- Name: INDEX index_clinic_mappings_on_default_true; Type: COMMENT; Schema: renalware; Owner: -
--

COMMENT ON INDEX renalware.index_clinic_mappings_on_default_true IS 'Enforces that there can only be one default clinic';
...
--
-- Name: index_good_jobs_jobs_on_finished_at_only; Type: INDEX; Schema: renalware; Owner: -
--

CREATE INDEX index_good_jobs_jobs_on_finished_at_only ON renalware.good_jobs USING btree (finished_at) WHERE (finished_at IS NOT NULL);
...
--
-- Name: index_good_jobs_on_concurrency_key_and_created_at; Type: INDEX; Schema: renalware; Owner: -
--

CREATE INDEX index_good_jobs_on_concurrency_key_and_created_at ON renalware.good_jobs USING btree (concurrency_key, created_at);
...
--
-- Name: index_good_jobs_on_job_class; Type: INDEX; Schema: renalware; Owner: -
--

CREATE INDEX index_good_jobs_on_job_class ON renalware.good_jobs USING btree (job_class);
...
CREATE INDEX index_patients_on_merged_into_patient_id ON renalware.patients USING btree (merged_into_patient_id);
...
--
-- Name: index_unique_default_gp_per_practice; Type: INDEX; Schema: renalware; Owner: -
--

CREATE UNIQUE INDEX index_unique_default_gp_per_practice ON renalware.patient_practice_memberships USING btree (default_gp, practice_id) WHERE ((default_gp = true) AND (deleted_at IS NULL));
...
--
-- Name: clinic_mappings fk_rails_0ffb18aec5; Type: FK CONSTRAINT; Schema: renalware; Owner: -
--
...
--
-- Name: patients fk_rails_a83dcaf11e; Type: FK CONSTRAINT; Schema: renalware; Owner: -
--

ALTER TABLE ONLY renalware.patients
    ADD CONSTRAINT fk_rails_a83dcaf11e FOREIGN KEY (merged_into_patient_id) REFERENCES renalware.patients(id);
