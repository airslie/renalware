class AddUKRDCRr51OutcomeCodeToLowClearanceDialysisPlans < ActiveRecord::Migration[8.0]
  def up
    within_renalware_schema do
...

      {
        ...
        Renalware::LowClearance::DialysisPlan.transaction do
          ...
          plan.presence&.update!(ukrdc_rr51_outcome_code: rr51_code)
        end
      end
    end
  end
  ...
  def down
    within_renalware_schema do
      remove_column :low_clearance_dialysis_plans, :ukrdc_rr51_outcome_code
    end
  end
end
