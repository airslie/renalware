      ...
      describe "#call" do
        context "when using default sort and no search argument" do
          it "returns a sorted collection of attachments for a patient" do
            att1 = create(:patient_attachment, patient: patient1, by: user)
            att2 = create(:patient_attachment, patient: patient1, by: user)
            ...
            create(:patient_attachment, patient: patient2, by: user)
