# An A12 event is used to undo a previous A02 (transfer) event.
# It should revert the patient's location to what it was before the A02 event.

# rubocop:disable Layout/LineLength
# Example message
#   MSH|^~\&|BLT_TIE|BLT|RENALWARE|MSE|20241104145144||ADT^A12|Q1663235323T1667361990X221284A1117|P|2.4
#   EVN|A12|20241104144000
...
describe "HL7 ADT^A12 message handling: 'Undo transfer'" do
  include HL7Helpers
  ...
  context "when patient is found but the admission is not" do
  ...
  context "when patient and the admission are found" do
    it "updates the admission, creating the unit and ward JIT if not found" do
      ...
      expect(Renalware::Admissions::Admission.count).to eq(1)
      ...
      expect(admission.hospital_ward.hospital_unit.unit_code).to eq("facility")
    end
  end
end
