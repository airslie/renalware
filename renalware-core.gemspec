...
Gem::Specification.new do |s|
  ...
  s.add_dependency "puma", "< 8" # Puma 7 may require testing due to call back changes
  ...
  s.add_dependency "tailwindcss-ruby", "~> 3.4"
  s.add_dependency "turbo-rails", "2.0.23"
