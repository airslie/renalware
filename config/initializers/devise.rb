...
Devise.setup do |config|
  ...
  # Range for password length. Demo and uat stages allow 8..128 to allow for easier testing,
  # but production requires 10..128
  config.password_length = Renalware.stage.production? ? 10..128 : 8..128
